...
def train(args, model, train_dataloader, val_dataloader, optimizers, device, model_saver):
    ...
    for epoch in range(args.epochs):
        ...
        print('Epoch: {} Train Loss: {:.4f}, {:.4f} Validation Loss: {:.4f}, {:.4f} '.format(epoch, train_generator_loss, train_discriminator_loss,
                                                                                              train_generator_loss, train_discriminator_loss))
